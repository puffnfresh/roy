...
var macros = {
    'import': [
        ...
        '    internals._.each(moduleTypes.types, function(v, k) {',
        '        var dataType = [new internals.types.TagNameType(k)];',
        '        internals._.each(function() {',
        '            dataType.push(new internals.types.Variable());',
        '        });',
        '        internals.env[k] = new internals.types.TagType(dataType);',
        '    });',
